...
export type BookReviews_ReviewsQuery = { reviews: Array<{ body: string, lang?: Maybe<string>, id: number, createdAt: string }> };
...
export type AuthorQQuery = { author?: Maybe<{ id: number, fullName: string, imageUrl?: Maybe<string>, books: Array<{ id: number, editions: Array<{ title: string, description?: Maybe<string>, id: number }> }> }> };
