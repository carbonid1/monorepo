...
import editionsMock, { emptyEdition } from './editions.mock';

type TReviews = 'rangeEng1' | 'rangeRu1' | 'rangeRu2';
type TReviewsMock = (drillTo?: number) => Record<TReviews, IReview>;

const reviewsMock: TReviewsMock = (drillTo = 4) => {
  ...
  return {
    rangeEng1: {
      ...
      lang: 'en',
      edition: nextDrill > 0 ? editionsMock(nextDrill).rangeEng : emptyEdition,
      createdAt: 'placeholder', // new Date('2021-02-11')
    },
    rangeRu1: {
      id: 2,
      lang: 'ru',
      createdAt: 'dfd', // new Date('2021-02-24')
      edition: nextDrill > 0 ? editionsMock(nextDrill).rangeRu : emptyEdition,
      body:
    ...
    rangeRu2: {
      id: 3,
      lang: 'en',
      createdAt: 'dfdf', //  new Date('2021-03-20')
      edition: nextDrill > 0 ? editionsMock(nextDrill).rangeRu : emptyEdition,
      body:
